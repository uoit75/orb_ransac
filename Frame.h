...
public:
     ...
     *  
     */
    Frame(const cv::Mat &imLeft, const cv::Mat &imRight, ORBextractor* extractorLeft, ORBextractor* extractorRight, cv::Mat &K, const float &bf, const float &thDepth);
     ...
     */
    void ComputeStereoMatches(const cv::Mat &imLeft, const cv::Mat &imRight);
